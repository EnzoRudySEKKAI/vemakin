...
class Project(Base):
    ...
    tasks = relationship("PostProdTask", back_populates="project", cascade="all, delete-orphan")

class Shot(Base):
    __tablename__ = "shots"

    id = Column(String, primary_key=True, index=True) # ID from frontend is string hash usually
...
class Equipment(Base):
    ...
    name = Column(String)
    catalog_item_id = Column(UUID(as_uuid=True), ForeignKey("gear_catalog.id"), nullable=True)
...
class GearCatalog(Base):
    ...
    camera_specs = relationship("CameraSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    lens_specs = relationship("LensSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    audio_specs = relationship("AudioSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    light_specs = relationship("LightSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    monitor_specs = relationship("MonitorSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    prop_specs = relationship("PropSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    stabilizer_specs = relationship("StabilizerSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    tripod_specs = relationship("TripodSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    wireless_specs = relationship("WirelessSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    drone_specs = relationship("DroneSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    filter_specs = relationship("FilterSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")
    grip_specs = relationship("GripSpecs", uselist=False, back_populates="gear", cascade="all, delete-orphan")

# --- Specialized Specs ---

class CameraSpecs(Base):
    __tablename__ = "specs_cameras"
    gear_id = Column(UUID(as_uuid=True), ForeignKey("gear_catalog.id"), primary_key=True)
