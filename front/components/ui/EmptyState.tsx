...
export const EmptyState: React.FC<EmptyStateProps> = ({
    ...
    return (
        <div className="col-span-full py-24 text-center flex flex-col items-center animate-in zoom-in-95 duration-500">
            ...
            <p className="text-sm font-bold uppercase tracking-wide text-gray-900 dark:text-white">
                {title}
            </p>
            {subtitle && (
            ...
            {action && (
                <button
                    ...
                    className="mt-8 flex items-center gap-3 px-10 py-4 bg-gradient-to-r from-indigo-600 to-indigo-600 dark:from-yellow-400 dark:to-orange-500 text-white dark:text-gray-900 rounded-[24px] font-bold text-[11px] uppercase tracking-widest shadow-[0_12px_24px_rgba(37,99,235,0.4)] dark:shadow-[0_12px_24px_rgba(250,204,21,0.2)] hover:shadow-[0_16px_32px_rgba(37,99,235,0.6)] dark:hover:shadow-[0_16px_32px_rgba(250,204,21,0.4)] active:scale-[0.98] transition-all"
                >
                    {action.label}
                </button>
            )}
