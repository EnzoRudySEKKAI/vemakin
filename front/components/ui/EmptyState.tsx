...
export const EmptyState: React.FC<EmptyStateProps> = ({
  ...
  const colorClasses = {
    blue: 'bg-primary/10 text-primary dark:text-primary border-blue-100 dark:border-primary/20',
    ...
    indigo: 'bg-indigo-50 dark:bg-primary/10 text-bg-primary dark:text-primary border-indigo-100 dark:border-primary/20',
