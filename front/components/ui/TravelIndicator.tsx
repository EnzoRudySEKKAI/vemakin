   ...
   >
    ...
    <div className="flex items-center gap-3 shrink-0">
     ...
     <div className="flex flex-col items-start leading-none">
      <span className={`text-xs font-semibold ${isTimeCritical ? 'text-red-700 dark:text-red-400' : 'text-gray-900 dark:text-white'}`}>
    ...
    <div className="flex flex-col items-end leading-none shrink-0 text-right">
     <span className={`text-sm font-semibold ${isTimeCritical ? 'text-red-700 dark:text-red-400' : 'text-gray-900 dark:text-white'}`}>
      {info.distance} km
     </span>
     <span className={`text-[11px] font-medium mt-1 ${isTimeCritical ? 'text-red-600 dark:text-red-400' : 'text-gray-500 dark:text-gray-400'}`}>
      {info.time} min
     </span>
    </div>
   </button>
