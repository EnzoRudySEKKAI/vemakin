    ...
    for (let d = 1; d <= daysInMonth; d++) {
      ...
      days.push(
        <button
          ...
          className={`
            w-8 h-8 rounded-full flex items-center justify-center text-[13px] font-semibold relative transition-all
            ${selected
        ...
        <>
          ...
          >
            ...
            <div className="grid grid-cols-7 mb-2 text-center">
              {daysOfWeek.map(day => (
                <span key={day} className="text-[10px] font-semibold text-gray-400 dark:text-gray-600">
                  {day}
                </span>
              ))}
            </div>
            ...
            <div className="mt-4 pt-3 border-t border-gray-100 dark:border-white/5 flex items-center justify-between">
              ...
              <button
                ...
                className="text-xs font-semibold text-red-500 hover:bg-red-50 dark:hover:bg-red-500/10 px-2 py-1 rounded transition-colors"
              >
                Clear
              </button>
            </div>
