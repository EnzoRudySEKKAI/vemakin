    ...
    return (
      ...
      >
        ...
        <div className="flex items-center flex-wrap gap-2">
          <span className="px-2.5 py-1 bg-gray-100 dark:bg-white/10 backdrop-blur-md text-gray-900 dark:text-white text-[10px] font-bold rounded-lg uppercase tracking-wider border border-gray-200 dark:border-white/10">
            Scene {shot.sceneNumber}
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-white/5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider">
            {formatDate(shot.date)}
          </span>
          <span className="px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-white/5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider">
            <Clock size={10} strokeWidth={2.5} /> {shot.startTime}
          </span>
          <span className="hidden md:block px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-gray-100 dark:border-white/5 text-[10px] font-bold uppercase tracking-wider">
            {shot.duration}
          </span>
        </div>
        ...
        {/* Title */}
        <div className="mt-3">
          <h3 className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white transition-colors">
            {shot.title}
          </h3>
        </div>
        ...
        <div className="flex items-end justify-between gap-4 mt-1 md:-mt-2">
          ...
          <div className="hidden md:flex items-center gap-3 shrink-0">
            ...
            {shot.equipmentIds.length > 0 && (
              <div className="hidden md:flex items-center gap-2 py-1.5 rounded-xl text-blue-600 dark:text-[#4E47DD] text-xs font-bold uppercase tracking-wide">
            ...
            <button
              ...
              className={`h-10 px-4 rounded-xl flex items-center gap-2 text-xs font-bold tracking-wide transition-all border ${isChecklistOpen
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center justify-between">
              <div className="flex flex-wrap items-center gap-2">
                ...
                <span className="px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-transparent dark:border-white/5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider">
                  {formatDate(shot.date)}
                </span>
                <span className="px-2.5 py-1 rounded-lg bg-gray-50 dark:bg-white/5 text-gray-500 dark:text-gray-400 border border-transparent dark:border-white/5 flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  className={`h-9 px-3 rounded-lg flex items-center gap-1.5 text-[10px] font-bold uppercase tracking-wider border transition-colors ${isChecklistOpen
                ...
                {shot.equipmentIds.length > 0 && (
                  <div className="flex items-center gap-2 py-1.5 rounded-lg text-blue-600 dark:text-[#4E47DD] text-xs font-bold uppercase tracking-wide">
                    <Package size={14} strokeWidth={2.5} />
