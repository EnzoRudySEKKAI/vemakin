  ...
  return (
    <>
      ...
      >
        ...
        >
          <div className="flex items-center justify-between gap-1 p-2 px-4 bg-[#0D0D0F] border border-white/[0.08] rounded-2xl pointer-events-auto w-full max-w-[400px]">
      ...
      <nav className="hidden lg:flex fixed left-0 top-0 h-screen w-[88px] xl:w-[280px] flex-col z-[1000] px-4 py-8 bg-[#0A0A0A]">
        {/* Logo Area */}
        <div className="px-4 mb-10 flex items-center lg:justify-center xl:justify-start gap-4">
          ...
          <span className="hidden xl:block text-xl font-bold text-white tracking-tight">Vemakin</span>
        </div>
        ...
        >
          <Plus size={24} strokeWidth={2.8} className="text-[#4E47DD] group-hover:rotate-90 transition-transform duration-300" />
