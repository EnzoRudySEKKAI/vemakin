                                        ...
                                        <div className="flex flex-col w-full gap-2 pb-1">
                                            <div className="h-[48px] flex items-center justify-start w-full gap-3">
                                                <button
                                                    ...
                                                    className={`w-10 h-10 rounded-xl bg-white dark:bg-white/10 flex items-center justify-center text-gray-700 dark:text-white transition-all font-bold ${backAction ? 'hover:bg-gray-100 dark:hover:bg-white/20' : 'opacity-50 cursor-default'}`}
                                                >
                                                    <ChevronLeft size={20} className="mr-0.5" strokeWidth={2.5} />
                                                </button>
                                                {detailTitle ? (
                                                    <div className="flex flex-col justify-center">
                                                        <span className="text-lg font-bold text-gray-900 dark:text-white leading-none whitespace-nowrap overflow-hidden text-ellipsis max-w-[200px] md:max-w-none">
                                                            {detailTitle}
                                                        </span>
                                                    </div>
                                                ) : (
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-3">
                                                            ...
                                                            <div className="flex flex-col items-start">
                                                                <span className="text-[9px] font-bold text-gray-500 uppercase tracking-widest">Current Production</span>
                                                            ...
                                                            <>
                                                                ...
                                                                >
                                                                    ...
                                                                    <button
                                                                        ...
                                                                        className="w-full flex items-center gap-3 p-4 rounded-2xl text-gray-900 dark:text-white font-bold hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
                                                                    >
                                                ...
                                                <div className="w-full bg-white dark:bg-[#1C1C1E]/50 backdrop-blur-md rounded-[16px] px-4 flex items-center gap-4 border border-gray-200 dark:border-white/5 shadow-sm h-[48px]">
                                                    ...
                                                    <div className="flex-1 flex items-center gap-2">
                                                        <div className="flex items-center gap-2 shrink-0">
                                                            ...
                                                            <span className="text-lg font-bold text-gray-900 dark:text-white tabular-nums">{Math.round(projectProgress)}%</span>
                                                        </div>
                                                    ...
                                                    <div className="flex items-center gap-4 shrink-0">
                                                        <div className="flex flex-col items-center">
                                                            <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Shots</span>
                                                            <span className="text-base font-black text-gray-900 dark:text-white leading-none">{Object.values(groupedShots).flat().length}</span>
                                                        </div>
                                                        <div className="flex flex-col items-center">
                                                            <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Done</span>
                                                        ...
                                                        <div className="flex flex-col items-center">
                                                            <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Remain</span>
                                                            <span className="text-base font-black text-gray-900 dark:text-white leading-none">
                                                                                    ...
                                                                                    >
                                                                                        {['All', 'Script', 'Editing', 'Sound', 'VFX', 'Color'].map(cat => (
                                                                                            <button
                                                                                                ...
                                                                                                className={`w-full text-left px-4 py-3 rounded-xl text-xs font-bold transition-colors ${postProdFilters?.category === cat ? 'bg-[#3762E3] dark:bg-[#4E47DD] text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5'}`}
                                                                                            >
                                                                                                {cat}
                                                                                            </button>
                                                                                        ))}
                                                                                    ...
                                                                                    >
                                                                                        ...
                                                                                        {[
                                                                                            ...
                                                                                            <button
                                                                                                ...
                                                                                                className={`w-full text-left px-4 py-2.5 rounded-xl text-xs font-bold transition-colors flex items-center justify-between ${postProdFilters?.sortBy === opt.value
                                                                ...
                                                                {mainView === 'postprod' && (
                                                                    <div className="flex items-center gap-4 w-full justify-between">
                                                                        ...
                                                                        <div className="hidden sm:flex items-center gap-6 shrink-0 px-2 h-10">
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[10px] font-black text-gray-400 uppercase leading-none mb-0.5">Total</span>
                                                                                <span className="text-base font-black text-gray-900 dark:text-white leading-none">
                                                                                    {tasks.length}
                                                                                </span>
                                                                            </div>
                                                                            ...
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[10px] font-black text-gray-400 uppercase leading-none mb-0.5">Done</span>
                                                                                <span className="text-base font-black text-gray-900 dark:text-white leading-none">
                                                                            ...
                                                                            <div className="w-px h-5 bg-gray-200 dark:bg-white/10" />
                                                                            <div className="flex flex-col items-center">
                                                                                <span className="text-[10px] font-black text-gray-400 uppercase leading-none mb-0.5">Remain</span>
                                                                                <span className="text-base font-black text-gray-900 dark:text-white leading-none">
                                                                                    {tasks.filter(t => t.status !== 'done').length}
                                                                                </span>
                                                                            </div>
                                                    ...
                                                    `}
                                                        ...
                                                        {mainView === 'inventory' && (
                                                            <div className="hidden sm:flex items-center gap-4 px-2 shrink-0">
                                                                <div className="flex flex-col items-center">
                                                                    <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Total Gear</span>
                                                                    <span className="text-base font-black text-gray-900 dark:text-white leading-none">{inventory.length}</span>
                                                                </div>
                                                                <div className="w-px h-6 bg-gray-200 dark:bg-white/10" />
                                                                <div className="flex flex-col items-center">
                                                                    <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Owned</span>
                                                                    <span className="text-base font-black text-blue-600 dark:text-blue-400 leading-none">
                                                                        {inventory.filter(i => i.isOwned).length}
                                                                    </span>
                                                                </div>
                                                                <div className="flex flex-col items-center">
                                                                    <span className="text-[10px] font-bold text-gray-400 uppercase leading-none mb-0.5">Rented</span>
                                                                                ...
                                                                                >
                                                                                    {statusOptions.map(opt => (
                                                                                        <button
                                                                                            ...
                                                                                            className={`w-full text-left px-4 py-3 rounded-xl text-xs font-bold transition-colors ${postProdFilters?.status === opt ? 'bg-[#3762E3] dark:bg-[#4E47DD] text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5'}`}
                                                                                        >
                                                                                            {getStatusLabel(opt)}
                                                                                        </button>
                                                                                    ))}
                                                                                ...
                                                                                >
                                                                                    {priorityOptions.map(opt => (
                                                                                        <button
                                                                                            ...
                                                                                            className={`w-full text-left px-4 py-3 rounded-xl text-xs font-bold transition-colors ${postProdFilters?.priority === opt ? 'bg-[#3762E3] dark:bg-[#4E47DD] text-white' : 'text-gray-600 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-white/5'}`}
                                                                                        >
