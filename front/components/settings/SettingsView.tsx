...
export const SettingsView: React.FC<SettingsViewProps> = ({
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* Account Section */}
      <section>
        <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 mb-3 px-2">Account</h3>

        {user ? (
          <GlassCard className="p-5 flex items-center justify-between mb-2 bg-white dark:bg-[#1A1A1D] border-none shadow-sm">
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 bg-blue-100 dark:bg-blue-500 dark:bg-indigo-500/20 rounded-full flex items-center justify-center text-blue-600 dark:text-indigo-600 dark:text-blue-400 dark:text-indigo-400 font-bold text-sm border-2 border-white dark:border-white/10 shadow-md">
                {getInitials(user.name)}
              </div>
              <div>
                <h3 className="text-sm font-bold text-gray-900 dark:text-white tracking-tight">{user.name}</h3>
          ...
          <GlassCard className="p-6 mb-2 flex flex-col items-center text-center gap-4 bg-white dark:bg-[#1A1A1D] border-none shadow-sm">
            ...
            <div>
              <h3 className="text-lg font-bold text-gray-900 dark:text-white tracking-tight">Vemakin Account</h3>
            ...
            <div className="flex gap-3 w-full mt-2">
              <button
                onClick={onLogin}
                className="flex-1 py-3 bg-gray-100 dark:bg-white/10 text-gray-600 dark:text-gray-300 rounded-xl font-bold text-[10px] hover:bg-gray-200 dark:hover:bg-white/20 transition-colors"
              >
                Log In
              </button>
              <button
                onClick={onLogin}
                className="flex-1 py-3 bg-blue-600 dark:bg-indigo-600 text-white rounded-xl font-bold text-[10px] hover:bg-blue-700 dark:bg-indigo-700 shadow-lg shadow-blue-200 dark:shadow-blue-900/30 transition-colors"
              >
                Sign Up
              </button>
            </div>
      ...
      {/* Workflow Section */}
      <section>
        <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 mb-3 px-2">Production Workflow</h3>
        <GlassCard
        ...
        >
          <div className="flex items-center gap-4">
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white tracking-tight">Project Management</h4>
      ...
      {/* Data & Cloud Section */}
      <section>
        <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 mb-3 px-2">Data & Cloud</h3>
        ...
        <div className="grid grid-cols-2 gap-4 mb-4">
          <button className="bg-white dark:bg-[#1A1A1D] p-4 rounded-[24px] shadow-sm hover:shadow-md transition-all active:scale-[0.98] flex flex-col items-center gap-3 text-center group">
            ...
            <span className="text-[10px] font-bold text-gray-600 dark:text-gray-300">Import data</span>
          </button>
          <button className="bg-white dark:bg-[#1A1A1D] p-4 rounded-[24px] shadow-sm hover:shadow-md transition-all active:scale-[0.98] flex flex-col items-center gap-3 text-center group">
            <div className="p-3 bg-blue-50 dark:bg-blue-500 dark:bg-indigo-500/10 text-blue-600 dark:text-indigo-600 dark:text-blue-400 dark:text-indigo-400 rounded-2xl group-hover:scale-110 transition-transform">
              <Upload size={20} strokeWidth={2.5} />
            </div>
            <span className="text-[10px] font-bold text-gray-600 dark:text-gray-300">Export data</span>
          </button>
        </div>
        ...
        <div className="bg-white dark:bg-[#1A1A1D] rounded-[32px] border border-white/40 dark:border-white/5 shadow-sm p-6 relative overflow-hidden">
          ...
          <div className="relative z-10 flex items-center justify-between mb-4">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h4 className="text-sm font-bold text-gray-900 dark:text-white">iCloud Backup</h4>
                <div className="flex items-center gap-1.5 mt-1">
                  <div className="w-1.5 h-1.5 rounded-full bg-emerald-500" />
                  <span className="text-[9px] font-bold text-gray-400">Last synced: 2m ago</span>
                </div>
              </div>
            </div>
            <button
      ...
      {/* Appearance Section */}
      <section>
        <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 mb-3 px-2">Appearance & Language</h3>
          ...
          <div className="p-5 flex items-center justify-between">
            ...
            <div className="relative group">
              <select
                ...
                className="appearance-none bg-gray-50 dark:bg-white/5 border border-gray-100 dark:border-white/5 text-gray-700 dark:text-gray-300 text-xs font-bold py-2 pl-4 pr-8 rounded-xl focus:outline-none cursor-pointer hover:bg-gray-100 dark:hover:bg-white/10 transition-colors"
              >
      ...
      {/* Resources Section */}
      <section>
        <h3 className="text-xs font-bold text-gray-400 dark:text-gray-500 mb-3 px-2">Resources</h3>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white tracking-tight">What's New</h4>
          ...
          >
            ...
            <div>
              <h4 className="text-sm font-bold text-gray-900 dark:text-white tracking-tight">Tutorial</h4>
      ...
      <section className="flex justify-center pt-4">
        <button className="flex items-center gap-2 px-6 py-3 rounded-full bg-gray-200/50 dark:bg-white/5 hover:bg-gray-200 dark:hover:bg-white/10 text-gray-500 dark:text-gray-400 transition-colors">
          <FileText size={14} />
          <span className="text-[10px] font-bold">Terms of Service & Privacy</span>
        </button>
      </section>

      <div className="text-center pb-8">
        <p className="text-[9px] font-bold text-gray-300 dark:text-gray-600">CineFlow OS v1.2.0</p>
      </div>
