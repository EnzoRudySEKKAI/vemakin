    ...
    return (
        <div className="space-y-8 animate-in fade-in duration-500">
            <div className="grid grid-cols-1 gap-8">
                {/* Department */}
                <div>
                    <label className="text-[10px] font-bold text-gray-400 tracking-wide mb-4 block ml-1 capitalize">Department</label>
                        ...
                        {TASK_CATEGORIES.map((cat) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <span className="text-[8px] font-bold tracking-wide uppercase">{cat.id}</span>
                                </button>
                            );
                        })}
                    </div>
                ...
                <div className="space-y-4">
                    {/* Title */}
                    <div>
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Task title</label>
                        <input
                            type="text"
                            value={form.title}
                            onChange={(e) => setForm({ ...form, title: e.target.value })}
                            className="w-full bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] px-6 py-5 text-base font-bold tracking-tight text-gray-900 dark:text-white focus:outline-none focus:border-blue-500 dark:border-indigo-500 dark:focus:border-yellow-400 transition-all placeholder-gray-200 dark:placeholder-gray-500"
                    ...
                    {/* Description */}
                    <div>
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Brief / Description</label>
                        <textarea
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <div>
                            <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Due date</label>
                            <div className="relative group min-w-0">
                                ...
                                <input
                                    ...
                                    className="w-full max-w-full bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-12 pr-4 py-4 text-sm font-bold focus:outline-none focus:border-blue-500 dark:border-indigo-500 dark:focus:border-yellow-400 transition-all text-gray-900 dark:text-white appearance-none"
                                />
                            </div>
                        </div>

                        <div>
                            <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Priority</label>
                            <div className="relative group">
                                <Flag className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-300 dark:text-gray-500" size={16} />
                                <select
                                    value={form.priority}
                                    onChange={(e) => setForm({ ...form, priority: e.target.value as any })}
                                    className="w-full bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-12 pr-8 py-4 text-sm font-bold focus:outline-none focus:border-blue-500 dark:border-indigo-500 dark:focus:border-yellow-400 transition-all text-gray-900 dark:text-white appearance-none cursor-pointer uppercase"
                                >
                ...
                <div className="p-6 bg-blue-50/50 dark:bg-yellow-500/5 rounded-[32px] border border-blue-100/50 dark:border-yellow-500/20 animate-in slide-in-from-top-4 duration-500">
                    <p className="text-[8px] font-bold text-blue-400 dark:text-indigo-400 dark:text-blue-400 dark:text-indigo-400 tracking-wide mb-4 capitalize">Pipeline parameters</p>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-6">
                        {form.category === 'Script' && (
                            <div>
                                <label className="text-[9px] font-bold text-indigo-700/60 dark:text-blue-400 dark:text-indigo-400/60 tracking-wide mb-2 block capitalize">Scene reference</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        placeholder="e.g. 14B"
                                        className="w-full bg-white dark:bg-[#2C2C30] border border-blue-100 dark:border-yellow-500/20 rounded-xl pl-10 pr-4 py-3 text-[11px] font-bold focus:outline-none shadow-sm text-gray-900 dark:text-white"
                                    />
                                </div>
                            </div>
                        )}
                        {form.category === 'Editing' && (
                            <>
                                <div>
                                    <label className="text-[9px] font-bold text-indigo-700/60 dark:text-blue-400 dark:text-indigo-400/60 tracking-wide mb-2 block capitalize">Target duration</label>
                                    <div className="relative">
                                ...
                                <div>
                                    <label className="text-[9px] font-bold text-indigo-700/60 dark:text-blue-400 dark:text-indigo-400/60 tracking-wide mb-2 block capitalize">Aspect ratio</label>
                                    <div className="relative">
                                        ...
                                        <select
                                            ...
                                            className="w-full bg-white dark:bg-[#2C2C30] border border-blue-100 dark:border-yellow-500/20 rounded-xl pl-10 pr-4 py-3 text-[11px] font-bold focus:outline-none shadow-sm appearance-none cursor-pointer text-gray-900 dark:text-white"
                                        >
