    ...
    <div className="fixed inset-0 z-[2000] bg-[#F2F2F7] flex flex-col animate-in fade-in duration-300">
      ...
      <div className="bg-white border-b border-gray-100 px-6 py-5 flex items-center justify-between shrink-0 shadow-sm z-10">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className="text-xl font-bold tracking-tight text-gray-900 leading-none">Help Center</h2>
            <p className="text-[11px] font-bold text-gray-400 mt-1 uppercase tracking-wide">Guides & Documentation</p>
          </div>
        </div>
        <button
          onClick={onClose}
      ...
      <div className="flex-1 overflow-y-auto custom-scrollbar p-6 md:p-8">
        <div className="max-w-3xl mx-auto space-y-8">
          ...
          <div className="bg-white rounded-[32px] p-8 shadow-sm border border-gray-100 text-center space-y-6">
            <h3 className="text-2xl font-bold text-gray-900 tracking-tight">How can we help you?</h3>
            <div className="relative max-w-lg mx-auto">
              ...
              <input
                ...
                className="w-full bg-gray-50 border-none rounded-2xl pl-12 pr-4 py-4 text-sm font-bold text-gray-900 focus:outline-none focus:ring-4 focus:ring-blue-500 dark:ring-indigo-500/10 transition-all placeholder-gray-400"
              />
            </div>
          </div>
          ...
          <div className="space-y-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center justify-between p-5">
                          <span className="font-bold text-sm text-gray-900 group-hover:text-blue-600 dark:text-indigo-600 transition-colors">
                            {item.question}
                          </span>
            ...
            {filteredGuides.length === 0 && (
              <div className="text-center py-20 opacity-50">
                ...
                <p className="text-sm font-bold text-gray-400">No guides found matching "{searchQuery}"</p>
              </div>
            )}
          </div>
          ...
          <div className="text-center pt-8 pb-4">
            <p className="text-[10px] font-bold text-gray-300 uppercase tracking-widest">CineFlow Documentation</p>
          </div>
        </div>
      </div>
    </div>
