        ...
        <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#F2F2F7] dark:bg-[#000000]">
            ...
            <div className="w-full max-w-md space-y-10 relative z-10">
                ...
                <div className="text-center space-y-6 animate-in slide-in-from-top-8 duration-700">
                    ...
                    <div>
                        <h1 className="text-5xl font-semibold text-gray-900 dark:text-white mb-2 font-display">Vemakin</h1>
                        <p className="text-base font-medium text-gray-500 dark:text-gray-400">Production OS</p>
                    </div>
                </div>
                ...
                <div className="space-y-4 animate-in slide-in-from-bottom-8 duration-700 delay-150">
                    <GlassCard className="p-1.5 bg-white/60 dark:bg-[#1A1A1D]/60 border-white/40 dark:border-white/10 shadow-xl backdrop-blur-xl">
                        <button
                            onClick={onSignIn}
                            className="w-full py-4 bg-[#111827] dark:bg-white text-white dark:text-black rounded-[24px] font-semibold text-sm shadow-xl hover:scale-[1.01] active:scale-[0.98] transition-all flex items-center justify-center gap-2.5"
                        >
                            Sign in
                    ...
                    <button
                        onClick={onSignUp}
                        className="w-full py-4 bg-white/40 dark:bg-white/5 backdrop-blur-sm border-2 border-white/60 dark:border-white/10 text-gray-900 dark:text-white rounded-[24px] font-semibold text-sm shadow-sm hover:bg-white/60 dark:hover:bg-white/10 active:scale-[0.98] transition-all"
                    >
                        Create account
                    </button>

                    {/* Social Logins - Temporarily removed to focus on Email/Pasword flow
     <div className="pt-3">
      <div className="flex items-center gap-6 mb-4">
       <div className="h-px bg-gray-300 dark:bg-gray-700 flex-1 opacity-50"/>
       <span className="text-[10px] font-semibold text-gray-400 dark:text-gray-500">or continue with</span>
       <div className="h-px bg-gray-300 dark:bg-gray-700 flex-1 opacity-50"/>
      </div>
      ...
      <div className="grid grid-cols-2 gap-3">
       ...
       >
        <AppleIcon />
        <span className="text-xs font-semibold text-gray-700 dark:text-gray-200">Apple</span>
       </button>
      </div>
     </div>
     */}
                    ...
                    <div className="pt-8 flex justify-center">
                        <button
                            onClick={onGuest}
                            className="text-xs font-semibold text-gray-400 dark:text-gray-500 hover:text-[#3762E3] dark:hover:text-[#4E47DD] transition-colors flex items-center gap-2 px-5 py-2.5 rounded-full hover:bg-white/50 dark:hover:bg-white/5"
                        >
