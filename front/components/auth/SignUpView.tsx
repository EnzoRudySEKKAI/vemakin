    ...
    <div className="min-h-screen flex flex-col items-center justify-center p-6 relative overflow-hidden bg-[#F2F2F7] dark:bg-[#000000]">
      ...
      <div className="w-full max-w-md relative z-10 animate-in slide-in-from-bottom-8 duration-700 fade-in">
        ...
        <div className="mb-10 text-center">
          <h2 className="text-4xl font-bold tracking-tighter text-gray-900 dark:text-white mb-3 font-display">Create account</h2>
        ...
        <GlassCard className="p-8 bg-white/60 dark:bg-[#1A1A1D]/60 border-white/40 dark:border-white/10 shadow-2xl shadow-blue-500/5 backdrop-blur-xl">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-400 dark:text-gray-500 ml-1 block uppercase tracking-wider">Full name</label>
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full bg-gray-50/50 dark:bg-white/5 border-none ring-1 ring-black/5 dark:ring-white/10 rounded-2xl pl-12 pr-6 py-4 text-base font-bold text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-[#3762E3]/20 dark:focus:ring-[#4E47DD]/40 focus:bg-white dark:focus:bg-[#2C2C2E] transition-all placeholder:font-medium placeholder:text-gray-400 dark:placeholder:text-gray-600"
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-400 dark:text-gray-500 ml-1 block uppercase tracking-wider">Email address</label>
              <div className="relative group">
            ...
            <div className="space-y-2">
              <label className="text-xs font-bold text-gray-400 dark:text-gray-500 ml-1 block uppercase tracking-wider">Password</label>
              <div className="relative group">
