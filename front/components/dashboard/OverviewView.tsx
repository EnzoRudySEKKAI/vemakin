            ...
            <div className="flex flex-col gap-6">
                ...
                <motion.section variants={itemVariants} className="w-full" onClick={onNavigateToInventory}>
                    <div className="flex items-center justify-between mb-3 px-2">
                        ...
                        <div className="flex items-center gap-1 text-sm font-bold text-blue-600 dark:text-indigo-600 dark:text-blue-400 dark:text-indigo-400 cursor-pointer hover:underline">
                        ...
                        <div className="flex flex-col md:flex-row gap-8 items-center">
                            ...
                            <div className="flex-1">
                                <div className="flex items-baseline gap-2 mb-2">
                                    <h3 className="text-5xl md:text-6xl font-black text-gray-900 dark:text-white tracking-tighter">{inventoryStats.totalItems}</h3>
                                    <span className="text-lg font-bold text-gray-400 uppercase tracking-widest">Items</span>
                                </div>
                            ...
                            <div className="w-full md:w-1/2 flex items-center justify-center gap-6">
                                ...
                                <div className="text-right hidden sm:block">
                                    <span className="block text-xs font-black text-gray-400 uppercase tracking-widest">Gear</span>
                                    <span className="block text-xs font-black text-gray-400 uppercase tracking-widest">Types</span>
                                </div>
                                {/* SVG Donut Chart */}
                                    ...
                                    {inventoryStats.donutSegments.map(segment => (
                                        <div key={segment.name} className="flex items-center justify-between text-xs">
                                            <div className="flex items-center gap-2">
                                                ...
                                                <span className="font-bold text-gray-700 dark:text-gray-300 truncate max-w-[80px]">{segment.name}</span>
                                            </div>
                ...
                <motion.section variants={itemVariants} className="w-full">
                    <div className="flex items-center justify-between mb-3 px-2">
                        <div className="flex items-center gap-3">
                            ...
                            <div className="px-2.5 py-0.5 rounded-full bg-blue-50 dark:bg-indigo-500/10 text-[10px] font-bold border border-blue-100 dark:border-indigo-500/20 text-blue-600 dark:text-[#4E47DD]">
                                {shots.filter(s => s.status === 'pending').length} Remaining
                            </div>
                        </div>
                        <button
                            onClick={onNavigateToShotsView}
                            className="flex items-center gap-1 text-sm font-bold text-blue-600 dark:text-indigo-600 dark:text-blue-400 dark:text-indigo-400 hover:underline"
                        >
                            View all <ChevronRight size={16} />
                        </button>
                    </div>
                                ...
                                <div className="relative z-10 flex flex-row items-start justify-between gap-4">
                                    <div className="flex-1 min-w-0">
                                        <div className="flex flex-wrap items-center gap-3 mb-3">
                                            <span className="px-3 py-1 bg-black/5 dark:bg-white/10 backdrop-blur-md text-gray-900 dark:text-white text-xs font-bold rounded-lg uppercase tracking-wider border border-black/5 dark:border-white/10">
                                                Scene {nextShot.sceneNumber}
                                            </span>

                                            <div className="flex items-center gap-1 text-xs font-bold text-gray-500 dark:text-gray-400 uppercase bg-white/40 dark:bg-white/5 px-2 py-1 rounded-lg">
                                                <Calendar size={12} />
                                        ...
                                        <div className="flex items-center gap-3 mb-2">
                                            <h3 className="text-2xl md:text-3xl font-bold text-gray-900 dark:text-white leading-tight truncate">
                                                {nextShot.title}
                                            </h3>
                                            ...
                                            <div className="flex items-center gap-2 md:hidden shrink-0">
                                                ...
                                                <span className="text-xs font-bold text-gray-500 uppercase">Gear</span>
                                                <span className="text-base font-bold text-gray-900 dark:text-white ml-0.5">{nextShot.equipmentIds?.length || 0}</span>
                                            </div>
                                        </div>
                                    ...
                                    {upcomingShots.slice(1).map((shot) => (
                                        ...
                                        >
                                            <div className="flex justify-between items-center">
                                                <span className="text-[10px] font-bold text-gray-400 uppercase">Sc {shot.sceneNumber}</span>
                                                <span className="text-[10px] font-bold text-blue-500 dark:text-indigo-500 dark:text-blue-400 dark:text-indigo-400">{formatDate(shot.date)}</span>
                                            </div>
                                            <p className="font-bold text-gray-900 dark:text-gray-100 text-sm truncate">{shot.title}</p>
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex items-center justify-between mb-3 px-2">
                            ...
                            <div
                                ...
                                className="flex items-center gap-1 text-sm font-bold text-blue-600 dark:text-indigo-600 dark:text-blue-400 dark:text-indigo-400 cursor-pointer hover:underline"
                            >
                                View all <ChevronRight size={16} />
                            </div>
                        </div>
                            ...
                            <div className="flex-1 space-y-2 z-10">
                                {pendingTasks.length > 0 ? pendingTasks.map(task => (
                                    ...
                                    >
                                        ...
                                        <span className="text-[10px] text-gray-400 dark:text-gray-500 uppercase">{task.status}</span>
                                    </div>
                                )) : (
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex items-center justify-between mb-3 px-2">
                            ...
                            <div
                                ...
                                className="flex items-center gap-1 text-sm font-bold text-blue-600 dark:text-[#4E47DD] cursor-pointer hover:underline"
                            >
                                View all <ChevronRight size={16} />
                            </div>
                        </div>
                                ...
                                {recentNotes.length > 0 ? (
                                    <div className="space-y-1">
                                        {recentNotes.map(note => (
                                            ...
                                            >
                                                <h4 className="font-bold text-gray-900 dark:text-white text-sm truncate mb-1">{note.title}</h4>
