            ...
            <div className="grid grid-cols-1 gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    <div className="sm:col-span-2">
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Custom name / Label</label>
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-12 pr-4 py-4 text-sm font-bold focus:outline-none focus:border-blue-500 dark:border-indigo-500 dark:focus:border-blue-500 dark:border-indigo-500 transition-all placeholder-gray-300 dark:placeholder-gray-500 text-gray-900 dark:text-white"
                                placeholder="e.g. A-Cam, Unit 1..."
                            />
                        </div>
                    </div>
                    <div>
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Serial number</label>
                        <div className="relative">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <select
                                ...
                                className="w-full appearance-none bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-12 pr-10 py-4 text-sm font-bold tracking-wide focus:outline-none focus:border-blue-500 dark:border-indigo-500 dark:focus:border-blue-500 dark:border-indigo-500 transition-all cursor-pointer text-gray-900 dark:text-white"
                            >
                    ...
                    {availableBrands.length > 0 && (
                        <div className="animate-in slide-in-from-left-2 duration-300">
                            <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Brand</label>
                            <div className="relative">
                ...
                {form.category === 'Lens' && availableMounts.length > 0 && (
                    <div className="animate-in slide-in-from-top-2 duration-300">
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Lens mount</label>
                        <div className="relative">
                ...
                {availableModels.length > 0 && (
                    <div className="animate-in slide-in-from-top-2 duration-300">
                        <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Model</label>
                        <div className="relative">
                ...
                {currentModelSpecs && (
                    <div className="animate-in fade-in duration-300">
                        <button
                            ...
                            className="flex items-center gap-2 text-[10px] font-bold tracking-wide text-blue-500 dark:text-indigo-500 dark:text-blue-400 dark:text-indigo-400 hover:text-blue-600 dark:text-indigo-600 dark:hover:text-blue-400 dark:text-indigo-400 transition-colors mb-2 ml-1 capitalize"
                        >
                            ...
                            <div className="grid grid-cols-2 gap-3 bg-gray-50 dark:bg-[#2C2C30] p-4 rounded-2xl border border-gray-100 dark:border-white/10 animate-in slide-in-from-top-1">
                                {Object.entries(currentModelSpecs).map(([k, v]) => (
                                    <div key={k} className="flex flex-col">
                                        <span className="text-[8px] font-bold text-gray-400 dark:text-gray-500 tracking-wide capitalize">{k.replace(/([A-Z])/g, ' $1').trim()}</span>
                                        <span className="text-[10px] font-bold text-gray-700 dark:text-gray-300">{String(v)}</span>
                                    </div>
                                ))}
                            </div>
                        )}
                ...
                <div className="space-y-4">
                    <div className="bg-gray-100/80 dark:bg-[#2C2C30] p-1.5 rounded-2xl flex gap-1">
                        <button
                            ...
                            className={`flex-1 py-3 rounded-xl text-[10px] font-bold tracking-wide transition-all capitalize ${form.isOwned
                    ...
                    {!form.isOwned && (
                        <div className="grid grid-cols-2 gap-4 animate-in slide-in-from-top-2">
                            <div>
                                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Rate</label>
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-10 pr-4 py-4 text-sm font-bold focus:outline-none focus:border-orange-500 dark:focus:border-orange-400 transition-all text-gray-900 dark:text-white"
                                        placeholder="0.00"
                                    />
                                </div>
                            </div>
                            <div>
                                <label className="text-sm font-bold text-gray-700 dark:text-gray-300 mb-2 block ml-1">Frequency</label>
                                <div className="relative">
                                    <select
                                        value={form.frequency}
                                        onChange={(e) => setForm({ ...form, frequency: e.target.value as any })}
                                        className="w-full appearance-none bg-white dark:bg-[#2C2C30] border-2 border-gray-100 dark:border-white/10 rounded-[20px] pl-4 pr-10 py-4 text-sm font-bold focus:outline-none focus:border-orange-500 dark:focus:border-orange-400 transition-all cursor-pointer text-gray-900 dark:text-white"
                                    >
