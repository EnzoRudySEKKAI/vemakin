    ...
    <div className="space-y-6">
      {filteredInventory.length > 0 ? (
        ...
        <div className="col-span-full py-20 flex flex-col items-center justify-center select-none">
          ...
          <h3 className="text-xl font-bold text-gray-500 dark:text-gray-400 tracking-tight uppercase">Empty repository</h3>
          <p className="text-[10px] font-bold text-gray-400 dark:text-gray-500 uppercase tracking-widest mt-2">No items match your criteria in Your Inventory</p>
        </div>
      )}
    </div>
  );
